        ...
        <div className='hidden lg:flex flex-col space-y-6'>
                ...
                <div>
                    <div className="p-4 text-black rounded-md h-full">
                        ...
                        <button
                            ...
                            className="px-6 py-2 border-2 border-black rounded-full hover:bg-black hover:text-white mt-10">
                            Shop Now
                        </button>
                    </div>
                </div>
            ...
            <div className='flex justify-between mx-auto w-3/4 h-80 bg-teal-300 rounded-lg'>
                <div>
                    <div className="p-4 text-black rounded-md h-full">
                        <p className="text-2xl font-bold mb-3">
                            Get the latest deal on electronics<br />
                            and accessories
                        </p>
                        <p className="text-md">
                            Discover powerful and stylish<br />
